...
test('garage setup is sanitized and materially changes the car',()=>{
  assert.deepEqual(P.sanitizeSetup({downforce:'rocket',frontWing:20,rearWing:0,rideHeight:99,camber:2,engineMode:'warp',fuelLoad:999,brakeBias:99,brakePressure:120,brakeCooling:999,differential:2,gearing:'long',compound:'soft',suspension:99,antiRoll:1,steering:72,tirePressure:18,frontTirePressure:19,rearTirePressure:99,frontToe:-4,rearToe:99,engineBraking:4}),{downforce:'balanced',frontWing:11,rearWing:1,rideHeight:45,camber:15,engineMode:'standard',fuelLoad:100,brakeBias:64,brakePressure:100,brakeCooling:100,differential:30,gearing:'long',compound:'soft',suspension:80,antiRoll:20,steering:70,tirePressure:20,frontTirePressure:20,rearTirePressure:27,frontToe:0,rearToe:20,engineBraking:20});
