...
for(const trackId of ['alpine','sunset','metro','emerald','thunder','zenith','aurora','sakura','marina','volcano','obsidian'])test('AI field completes three clean laps at '+trackId,()=>{
