...
for(const trackId of ['alpine','sunset','metro','emerald','thunder','zenith','aurora','sakura','marina','volcano','obsidian','titan','vesper'])test('AI field completes three clean laps at '+trackId,()=>{
