...
trackCopy.lotus={intro:'Flow across a rain-bright delta where sweeping arcs meet a tight, technical lotus complex.',character:'MONSOON GRAND PRIX',weather:'☂',temperature:'25° · TRACK 29°'};
...
async function connectServer(value,quiet=false){
  ...
  try{
    ...
    const info=await res.json();if(info.app!=='apex-circuit'||info.version!==Physics.VERSION||info.protocol!==15)throw new Error('This server needs the Onboard Tour update.');
